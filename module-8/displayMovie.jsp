...
<%
    ...
    out.println("<p style='color:red; font-weight:bold;'>DEBUG: displayMovie.jsp loaded from module-8</p>");
    ...
    out.println("<p style='color:red; font-weight:bold;'>DEBUG movies size = " + movies.size() + "</p>");
%>
